      ...
      <section className="flex justify-center  bg-dotted-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl ">
          <Image
            ...
            width={800}
            height={800}
            className="h-full min-h-[200px] object-cover object-center rounded-2xl"
          />

          <div className="flex w-full flex-col gap-8 bg-black text-white p-5 md:p-10">
            <div className="flex flex-col gap-6">
              <h2 className="h2-bold">{event.title}</h2>

              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex gap-3">
                  <p className="p-bold-20 rounded-full bg-green-800 px-5 py-2 text-white">
                    {event.isFree ? "FREE" : `$${event.price}`}
                  </p>
                  <p className="p-medium-16 rounded-full bg-grey-600 px-4 py-2.5 text-white">
                    {event.category.name}
                  </p>
                </div>
